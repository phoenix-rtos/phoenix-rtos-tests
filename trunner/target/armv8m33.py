...
class MCXN947PloAppLoader(TerminalHarness, PloInterface):
    ...
    def __call__(self):
        ...
        for app in self.apps:
            ...
            # There is a hardware difference between the test unit and out-of-box unit related
            # to the MCU-Link power supply configuration which cause second reboot after binary load
