...
def parse_args():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python cmp.py old_results.json new_results.json -v --threshold 5.0 -t ia32-generic-qemu",
    )

    parser.add_argument("file_old", metavar="FILE_OLD", help="Path to the old benchmark results file.")
    parser.add_argument("file_new", metavar="FILE_NEW", help="Path to the new benchmark results file.")
