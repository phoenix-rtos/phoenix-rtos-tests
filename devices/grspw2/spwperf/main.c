...
#define SPWPERF_TEST_DATASZ   (1024u - SPW_RX_MIN_BUFSZ - SPWPERF_TEST_HDRSZ)
...
static void spwperf_clientThread(void *arg)
{
	...
	static const uint8_t hdr[] = { SPWPERF_S_ADDR, /* protocol ID */ 0x5 }, data[SPWPERF_TEST_DATASZ] = { [0 ... SPWPERF_TEST_DATASZ - 1] = 0x5 };
	static const size_t hdrSz = sizeof(hdr), dataSz = sizeof(data);
